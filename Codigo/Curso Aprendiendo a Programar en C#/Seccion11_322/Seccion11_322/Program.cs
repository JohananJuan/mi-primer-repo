    ...
    internal class Program
    {
        ...
        static void ExplorarDirectorio(string directorioPa)
        {
            ...
            while (continuar)
            {
                ...
                Console.Write("Ingresa el numero de la opcion que sedeas explorar(o 'a' para ir hacia atras en l;a ruta, 'n' para ingresar a una nueva ruta, o 's' para salir)");
